...
UE.I18N['en'] = {
    ...
    'autoupload': {
        ...
        'jsonEncodeError': 'Server Return Format ErrorController',
        'loading':"loading...",
    ...
    'insertimage':{
        ...
        'errorUploadRetry':'Upload ErrorController, Please Retry.',
        'errorHttp':'Http ErrorController',
        'errorServerUpload':'Server Result ErrorController.',
        'remoteLockError':"Cannot Lock the Proportion between width and height",
        'numError':"Please enter the correct Num. e.g 123,400",
        'imageUrlError':"The image format may be wrong!",
        'imageLoadError':"ErrorController,please check the network or URL！",
