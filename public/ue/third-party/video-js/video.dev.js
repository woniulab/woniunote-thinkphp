 ...
 * @param  {Function=} onError    ErrorController callback
 * @private
 */
  ...
  try {
    ...
    if (e.code == 22 || e.code == 1014) { // Webkit == 22 / Firefox == 1014
      ...
      if (e.code == 18) {
        ...
        vjs.log('LocalStorage ErrorController (VideoJS)', e);
      }
    }
  }
};
...
vjs.Player.prototype.onError = function(e) {
  vjs.log('Video ErrorController', e);
};
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      vjs.on(iFrm, 'load', vjs.bind(this, function(){
        ...
        iWin['errors'] = vjs.bind(this.player_, function(swfID, eventName){
          vjs.log('Flash ErrorController', eventName);
        });
...
vjs.Flash['onError'] = function(swfID, err){
  ...
  vjs.log('Flash ErrorController', err, swfID);
};
